...
function canMove(nx,ny){const room=rooms[roomIndex];if(nx<0||ny<0||nx>=10||ny>=10)return false;for(const w of room.walls){if(w.y===0&&room.exit&&nx===room.exit.x&&ny===0)continue; // allow passage at exit
